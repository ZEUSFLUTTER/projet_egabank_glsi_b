...
import com.egabank.Backend.dto.UtilisateurResponseDTO;
...
public class AuthentificationControleur {
    ...
    public UtilisateurResponseDTO inscription(@Valid @RequestBody UtilisateurCreateDTO dto) { 
        Utilisateur utilisateur = serviceAuthentification.creer(dto);
        return new UtilisateurResponseDTO(utilisateur.getId(), utilisateur.getNomUtilisateur(), utilisateur.getRole());
    }
}
