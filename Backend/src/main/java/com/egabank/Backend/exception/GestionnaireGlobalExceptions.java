...
public class GestionnaireGlobalExceptions {
    ...
    public ResponseEntity<Map<String, Object>> gererUtilisateurIntrouvable(UsernameNotFoundException ex) {
        return construire(HttpStatus.UNAUTHORIZED, "Identifiants incorrects");
    }

    @ExceptionHandler(AuthenticationException.class)
    public ResponseEntity<Map<String, Object>> gererAuthentification(AuthenticationException ex) {
        return construire(HttpStatus.UNAUTHORIZED, "Identifiants incorrects");
    }
