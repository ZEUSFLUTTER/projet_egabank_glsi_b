...
-- Compatible avec MySQL de XAMPP

-- Création de la base de données
CREATE DATABASE IF NOT EXISTS bank_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE bank_db;

-- Suppression des tables existantes pour recréer proprement (optionnel)
...
-- Données de test
-- Insertion des utilisateurs par défaut (mot de passe: "password" encodé en BCrypt)
...
INSERT IGNORE INTO clients (nom, prenom, date_naissance, sexe, adresse, numero_telephone, courriel, nationalite) VALUES 
...
INSERT IGNORE INTO comptes (numero_compte, type_compte, solde, proprietaire_id) VALUES 
...
INSERT IGNORE INTO transactions (type_transaction, montant, description, compte_id, solde_avant, solde_apres) VALUES 
