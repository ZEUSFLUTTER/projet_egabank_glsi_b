    ...
    <div class="min-h-screen bg-white">
      ...
      <nav class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md">
        <div class="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <div class="flex items-center gap-3">
            <img src="/assets/logoega.png" alt="EGA Bank" class="h-16 md:h-20 w-auto" />
            <span class="text-xl font-semibold text-slate-800">Ega Bank</span>
          </div>
          
          <div class="flex items-center gap-6">
            <a href="#fonctionnalites" class="text-sm text-slate-600 hover:text-slate-900 transition-colors">Fonctionnalités</a>
            <a href="#specifications" class="text-sm text-slate-600 hover:text-slate-900 transition-colors">Spécifications Techniques</a>
            <span class="px-3 py-1 bg-slate-100 text-slate-600 text-xs font-medium ">v1.0.0 Alpha</span>
      ...
      <section class="relative pt-32 pb-20 px-6 overflow-hidden bg-white">
        ...
        <div class="max-w-6xl mx-auto relative text-center">
          ...
          <h1 class="text-6xl md:text-7xl font-bold text-gradient mb-6 leading-tight">
            Gestion bancaire<br>nouvelle génération.
          </h1>
          
          <p class="text-xl text-slate-600 max-w-3xl mx-auto mb-12 leading-relaxed">
            Une architecture distribuée robuste pour la gestion des comptes clients, transactions sécurisées et conformité bancaire. Propulsé par Java EE, Spring et Angular.
          </p>
      ...
      <!-- Features Section -->
      <section id="fonctionnalites" class="relative py-20 px-6 bg-white overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto relative">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="group p-8 bg-white rounded-xl border border-slate-200 hover:border-purple-400 hover:shadow-lg transition-all duration-300">
              ...
              <p class="text-slate-600 leading-relaxed">
                Authentification JWT robuste, rôles ADMIN/CLIENT, validation des contraintes métier et auditabilité complète.
              </p>
            </div>
      ...
      <!-- Tech Specs Section -->
      <section id="specifications" class="relative py-20 px-6 bg-white overflow-hidden">
        <!-- Geometric Accents -->
        ...
        <div class="max-w-6xl mx-auto relative">
          ...
          <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="text-center p-8 bg-slate-50 rounded-xl border border-slate-200 hover:border-green-300 hover:shadow-lg transition-all">
              ...
              <p class="text-green-600 font-medium mb-4">Spring Boot 3.2.0</p>
            ...
            <div class="text-center p-8 bg-slate-50 rounded-xl border border-slate-200 hover:border-red-300 hover:shadow-lg transition-all">
              ...
              <p class="text-red-600 font-medium mb-4">Angular 19 + Tailwind</p>
              <ul class="text-sm text-slate-500 space-y-1.5">
            ...
            <div class="text-center p-8 bg-slate-50 rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-lg transition-all">
              ...
              <p class="text-blue-600 font-medium mb-4">PostgreSQL 16</p>
              <ul class="text-sm text-slate-500 space-y-1.5">
                <li>• Relations JPA</li>
      ...
      <!-- GitHub Section -->
      <section id="depot" class="py-20 px-6 bg-white">
      ...
      <!-- Footer -->
      <footer class="bg-white text-slate-600 py-12 px-6 border-t border-slate-200">
