    ...
    <div class="settings-container">
      ...
      <header class="settings-header animate-slide-in">
        <div class="header-content">
          ...
          <div class="header-actions">
            <span class="last-updated">Dernière modification: {{ lastUpdated }}</span>
          </div>
        </div>
      </header>
      ...
      <div class="settings-layout">
        ...
        <div class="settings-content">
          ...
          <!-- Preferences Tab (NEW) -->
          <div *ngIf="activeTab === 'preferences'" class="settings-panel animate-fade-in">
            <div class="panel-header">
              <i class="ri-palette-line"></i>
              <div>
                <h2 class="panel-title">Préférences d'Apparence</h2>
                <p class="panel-subtitle">Personnalisez l'apparence de l'application</p>
              </div>
            </div>
            
            <div class="preferences-section">
              <div class="preference-group">
                <h3 class="group-title">Thème</h3>
                <div class="theme-options">
                  <div class="theme-option" [class.selected]="theme === 'light'" (click)="setTheme('light')">
                    <div class="theme-preview light-theme">
                      <i class="ri-sun-line"></i>
                    </div>
                    <span>Clair</span>
                  </div>
                  <div class="theme-option" [class.selected]="theme === 'dark'" (click)="setTheme('dark')">
                    <div class="theme-preview dark-theme">
                      <i class="ri-moon-line"></i>
                    </div>
                    <span>Sombre</span>
                  </div>
                  <div class="theme-option" [class.selected]="theme === 'auto'" (click)="setTheme('auto')">
              ...
              <div class="preference-group">
                <h3 class="group-title">Langue</h3>
              ...
              <div class="preference-group">
                <h3 class="group-title">Format de Date</h3>
                <div class="radio-options">
                  <label class="radio-option">
                    <input type="radio" name="dateFormat" value="dd/mm/yyyy" checked>
                    <span>JJ/MM/AAAA (18/01/2026)</span>
                  </label>
                  <label class="radio-option">
                    <input type="radio" name="dateFormat" value="mm/dd/yyyy">
                    <span>MM/JJ/AAAA (01/18/2026)</span>
                  </label>
                </div>
              </div>

              <div class="preference-group">
                <h3 class="group-title">Devise</h3>
                <select class="language-select">
          ...
          <!-- About Tab (NEW) -->
          <div *ngIf="activeTab === 'about'" class="settings-panel animate-fade-in">
            <div class="panel-header">
              <i class="ri-information-line"></i>
              <div>
                <h2 class="panel-title">À propos d'EGA Bank</h2>
                <p class="panel-subtitle">Informations sur l'application</p>
              </div>
            </div>
            
            <div class="about-section">
              <div class="app-info-card">
                <img src="/assets/logo.jpeg" alt="EGA Bank" class="app-logo">
                <h3 class="app-name">EGA Bank</h3>
                <p class="app-tagline">Votre partenaire bancaire de confiance</p>
              ...
              <div class="legal-links">
                ...
                <a href="#" class="legal-link">Licences Open Source</a>
              </div>
            </div>
          </div>
...
export class SettingsComponent implements OnInit {
  activeTab: 'profile' | 'security' | 'notifications' | 'preferences' | 'about' = 'profile';
