...
export class ClientDashboardService {
  ...
  getDashboard(): Observable<DashboardData> {
    return this.http.get<DashboardData>(`${this.apiUrl}/dashboard`, { headers: this.getAuthHeaders() });
  }

  getComptes(): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/comptes`, { headers: this.getAuthHeaders() });
  }

  getTransactions(): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/transactions`, { headers: this.getAuthHeaders() });
  }
