  ...
  features = [
    {
      ...
      description: 'Vos actifs sont protégés par une infrastructure de cybersécurité de classe mondiale et un chiffrement de bout en bout.',
    ...
    },
    {
      ...
      description: 'Accédez à des outils d\'investissement exclusifs et pilotez votre patrimoine avec une précision chirurgicale.',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
    ...
    },
    {
      ...
      description: 'Un banquier privé dédié et une équipe de support disponibles à tout instant pour vos exigences les plus élevées.',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
