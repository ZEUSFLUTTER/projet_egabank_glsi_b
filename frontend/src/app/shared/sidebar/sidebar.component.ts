...
export class SidebarComponent {
  ...
  navLinks = [
    ...
    },
    {
      ...
      href: '/dashboard/admin/new-client',
      icon: 'M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 018.924 21c-2.331 0-4.512-.645-6.374-1.766z',
      role: 'ADMIN'
    },
    {
