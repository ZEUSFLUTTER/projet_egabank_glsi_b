...
```
# pour ma part j'utilise le port 8083 
...
```
TP_JEE_GLSI_B_PITO_TILARI_Essoron_Julien/
├── backend/
│   └── ega-bank/
│       ├── src/
│       │   ├── main/
...
**Erreur possible**: Port 8083 déjà utilisé
...
**Solutions**:
1. Vérifiez que le backend est démarré sur http://localhost:8083
...
4. Accédez à la console H2 pour voir les données: http://localhost:8083/h2-console